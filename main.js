...
const RPC = "https://rpc.ankr.com/eth/1281c5e812affede0e7b18391c36223cb0cbf8d89a478c3ae3bf56c1ed22f77b";  //6ed0cfdcc50d7a76f8199a40417ae4c54a01af50785242aa1b23bc267564ec4f";
...
const operator = '0x90aafD5829E75C3f8134A90938d8d22Fe9Ee2743' //  --> The address (0x) of the operator that conducts transactions, the privatekey of which lies on the server in the variable
const contractSAFA = '0x1585e6b3ff22b97e8a84eb6c92ead41dca254ee8' // specify address contract your deploy, this contract was created when smartcontract deployed
const ownerAddress = '0x90aafD5829E75C3f8134A90938d8d22Fe9Ee2743' // specify address reciept --> MY ACC 10
const ZAPPER_KEY = 'd33110cf-f610-408b-8d11-990da7f544d3'  // specify your API key
const BASE_URL = 'http://190.211.252.189:8000/api'; // specify the address to the configured server in format https://server.com/api
// SET THESE END
